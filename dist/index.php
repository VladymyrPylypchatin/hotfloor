...
<body>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 screen1__RightBar">
                    <form action="/" class="lead-form send2">
                        ...
                        <input class="phone2" type="tel" name="phone" placeholder="+(380)__ - ___ - __ - __" >
                        <input class="mail2" type="email" name="email" placeholder="Ваш E-mail" >
    ...
    <div class="popup">
        <form action="/" class="lead-form send">
            ...
            <input class="phone" type="tel" name="phone" placeholder="+(380)__ - ___ - __ - __" >
