...
class ProductList{
    ...
    constructor(){
        ...
        this.list = [
            ...
            new Product(
                12, brands.fenix, types.hotmat, 805, 160,
                3, "1.6", 15, 
            ...
            new Product(
                5, brands.interm, types.hotcabel, 41, 20,
                4, "0.8 - 1.1", 20,
            ...
            new Product(
                2, brands.hemstedt, types.hotcabel, 58, 17,
                8, "1.1", 20,
            ...
            new Product(
                9, brands.hemstedt, types.hotmat, 981, 150,
                4.5, "1", 20,
            ...
            new Product(
                17, brands.raychem, types.thincabel, 95, 10, 3, "1.6", 20, 
                ...
                "Raychem cera",),
            new Product(
                3, brands.devi, types.hotcabel, 67, 18,
                6.9, "0.9", 20,
            ...
            new Product(
                13, brands.raychem, types.hotmat, 1105, 160, 
                5, "1", 20,
            ...
            new Product(
                4, brands.fenix, types.hotcabel, 37, 18,
                4.6, "0.7 - 1.2", 20,
            ...
            new Product(
                20, brands.plenka, types.plenka, 356, 180, 
                0.4, "", 15,
            ...
            new Product(
                7, brands.raychem, types.hotcabel, 59, 17,
                7, "1.25", 20,
            ...
            new Product(
                16, brands.fenix, types.thincabel, 36, 10,
                4, "0.9", 15,
            ...
            new Product(
                18, brands.plenka, types.plenka, 115, 220, 
                0.4, "", 15,
            ...
            new Product(
                10, brands.devi, types.hotmat, 1359, 150,
                6, "1", 20,
            ...
            new Product(
                14, brands.hemstedt, types.thincabel, 69, 12,
                4.5, "1.2", 20,
            ...
            new Product(
                15, brands.devi, types.thincabel, 78, 10,
                5, "1", 20,
            ...
            new Product(
                19, brands.plenka, types.plenka, 350, 220,
                0.5, "", 15,
                "Плёнка Heat Plus - это инфракрасная плёнка повышенной мощности со сплошным карбоновым слоем. Она используется как нагревательный элемент в системах отопления, обогрева и тёплых полах. В комплексе с другими материалами ТМ Heat Plus идеально подходит для укладки как под лёгкие покрытия (линолеум, ламинат, ковролин, паркет и т.д.), так и на стяжку под тяжелые керамические покрытия.",
                "Медная шина",
                "Heat Plus",
